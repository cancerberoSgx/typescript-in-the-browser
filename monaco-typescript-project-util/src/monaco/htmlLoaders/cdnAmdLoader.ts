 ...
 */
export const cdnAmdLoader = (baseUrl: string) => (
`
...
<script>var require = { paths: { 'vs': '${baseUrl}vs' } };
...
<script src="${baseUrl}vs/loader.js"></script>
<script src="${baseUrl}vs/editor/editor.main.nls.js"></script>
<script src="${baseUrl}vs/editor/editor.main.js"></script>
${/*
Heads up ! 
